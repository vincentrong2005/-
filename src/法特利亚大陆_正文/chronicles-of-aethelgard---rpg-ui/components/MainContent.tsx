...
export const MainContent: React.FC<MainContentProps> = ({
  ...
  return (
    ...
    >
      ...
      {showUpdateContent && (
        <div
          className={`absolute top-16 z-20 w-96 max-h-[80vh] bg-[#0f1018f2] border border-[var(--gold-700)]/40 rounded-xl p-4 shadow-[0_15px_40px_rgba(0,0,0,0.6)] backdrop-blur-xl animate-slideUp flex flex-col ${showSettings ? 'right-[280px]' : 'right-4'}`}
        >
